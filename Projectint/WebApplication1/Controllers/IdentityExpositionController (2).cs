...
namespace WebApplication1.Controllers
{
    public class IdentityExpositionController : ApiController
    {
        ...
        [HttpPost]
        public HttpResponseMessage user([FromBody] Domain.Entities.User a)
        {
            ...
            try
            {
                ...
                var message = Request.CreateErrorResponse(HttpStatusCode.Created, u.ToString());
                message.Headers.Location = new Uri(Request.RequestUri + u.ToString());
